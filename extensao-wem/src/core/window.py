...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        #self.__classAttributes = ifcproject.MaterialSettings
    ...
    def __GetUserInput(self):
        ...
        self.__materialSettings  = ifcproject.MaterialSettings(getData()[0],getData()[1],getData()[2],0.9) 
    def __GenerateProject(self):
        self.__GetUserInput() 
        # Generate the IFC project
        project = ifcproject.Project(structureSettings=self.__structureSettings,materialSettings = self.__materialSettings)
